...
section .data
    name        db 'John Doe', 0ah, 0dh, '$'         ; Name followed by newline and carriage return
    roll_number db 'Roll No: 12345', 0ah, 0dh, '$'   ; Roll number followed by newline and carriage return
